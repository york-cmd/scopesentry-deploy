...
exec env \
  ...
  TASK_MODE="${TASK_MODE:-legacy}" \
  STREAM_PORTSCAN_ENABLED="${STREAM_PORTSCAN_ENABLED:-false}" \
  STREAM_SUBDOMAIN_ENABLED="${STREAM_SUBDOMAIN_ENABLED:-false}" \
  STREAM_SUBDOMAIN_CHUNK_TIMEOUT_SECONDS="${STREAM_SUBDOMAIN_CHUNK_TIMEOUT_SECONDS:-7200}" \
