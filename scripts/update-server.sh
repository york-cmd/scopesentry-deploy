...
exec bash -c "$(curl -fsSL "https://raw.githubusercontent.com/${DEPLOY_REPO_OWNER}/${DEPLOY_REPO_NAME}/${DEPLOY_REPO_BRANCH}/scripts/install-server.sh")" -- --upgrade
